    ...
    <div style={styles.container}>
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.leftCol}>
          ...
          <div style={styles.card}>
            <h2 style={styles.cardTitle}>Engine Preferences</h2>
        ...
        {/* Right column - Protected Terms & Account */}
        <div style={styles.rightCol}>
          ...
          <div style={styles.card}>
            ...
            <p style={styles.cardDesc}>Manage your profile details and API tokens</p>
...
const styles = {
  ...
  termsBox: {
    display: "flex", flexWrap: "wrap", gap: 6, padding: 10, background: "var(--bg-page)",
    border: "1px solid var(--border)", borderRadius: 8, minHeight: 80, alignContent: "flex-start",
  },
