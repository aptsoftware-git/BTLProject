...
class ChunkMetadata(BaseModel):
    ...
    association_method: Optional[str] = Field("none", description="Method used for context association: explicit_caption, same_card_layout, section_spatial_context, surrounding_text, vlm_semantic_description, none")
